...
import type { Vec2 } from "./core/math2d.ts";
...
export class Viewport {
   ...
   */
  zoomAt(anchorScreen: Vec2, factor: number): boolean {
  ...
  fitBounds(bounds: { min: Vec2; max: Vec2 }, padding = 1.4): void {
