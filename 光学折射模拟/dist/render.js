...
import { dirFrom, perp, scale, add } from "./core/math2d.js";
...
export class Renderer {
  ...
  /* ---------------------------------------------------------- 叠加图层 */
   ...
   drawElementLabel(el , geo , selected )  {
    const ctx = this.ctx;
    const vp = this.view;
